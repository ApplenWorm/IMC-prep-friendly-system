Linear Algebra
- [x] 1. Linear Algebra Done Right (3rd ed.) — Sheldon Axler - done
- [x] 2. Linear Algebra (2nd ed.) — Kenneth Hoffman & Ray Kunze - done
- [x] 3. Linear Algebra — Stephen H. Friedberg, Arnold J. Insel, and Lawrence E. Spence - done
- [x] 4. Problems and Theorems in Linear Algebra — V.V. Prasolov - done
- [x] 5. Matrix Analysis — Roger Horn & Charles Johnson - done
- [x] 6. Advanced Linear Algebra — Steven Roman - done
- [x] 7. Linear Algebra Problem Book — Paul R. Halmos
Real Analysis
- [x] 8. Understanding Analysis (2nd ed.) — Stephen Abbott
- [x] 9. Principles of Mathematical Analysis (3rd ed.) — Walter Rudin
- [x] 10. Mathematical Analysis (2nd ed.) — Tom Apostol
- [x] 11. Real Mathematical Analysis — Charles Pugh
- [x] 12. Real Analysis — Royden & Fitzpatrick
- [x] 13. Problems in Real Analysis: Advanced Calculus on the Real Axis — Radulescu, Radulescu & Andreescu
