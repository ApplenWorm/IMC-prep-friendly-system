Linear Algebra
- [ ] 1. Linear Algebra Done Right (3rd ed.) — Sheldon Axler - done
- [ ] 2. Linear Algebra (2nd ed.) — Kenneth Hoffman & Ray Kunze - done
- [ ] 3. Linear Algebra — Stephen H. Friedberg, Arnold J. Insel, and Lawrence E. Spence - done
- [ ] 4. Problems and Theorems in Linear Algebra — V.V. Prasolov - done
- [ ] 5. Matrix Analysis — Roger Horn & Charles Johnson - done
- [ ] 6. Advanced Linear Algebra — Steven Roman - done
- [ ] 7. Linear Algebra Problem Book — Paul R. Halmos
Real Analysis
- [ ] 8. Understanding Analysis (2nd ed.) — Stephen Abbott
- [ ] 9. Principles of Mathematical Analysis (3rd ed.) — Walter Rudin
- [ ] 10. Mathematical Analysis (2nd ed.) — Tom Apostol
- [ ] 11. Real Mathematical Analysis — Charles Pugh
- [ ] 12. Real Analysis — Royden & Fitzpatrick
- [ ] 13. Problems in Real Analysis: Advanced Calculus on the Real Axis — Radulescu, Radulescu & Andreescu
- [ ] 14. Problems in Mathematical Analysis (Volumes 1, 2, and 3) — W.J. Kaczor and M.T. Nowak
- [ ] 15. A Problem Book in Real Analysis — Asuman G. Aksoy and Mohamed A. Khamsi
- [ ] 16. Counterexamples in Analysis — Gelbaum & Olmsted
